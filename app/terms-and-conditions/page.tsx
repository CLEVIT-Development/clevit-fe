...
const TermsAndConditionsPage = () => {
  ...
  return (
    <div className="w-full flex flex-col items-center space-y-[50px]">
      ...
      <DocumentSection
        ...
        description={
          <>
            ...
            <Link href={appConfig.websiteDomain} className="text-purple-300">
              {urlShortener(appConfig.websiteDomain)}
            </Link>
            , and any services or products offered therein. By accessing or using our website, you
            agree to abide by these terms and conditions. If you do not agree with any part of these
      ...
      <DocumentSection
        ...
        listItems={[
          <>
            <Link href={RoutePaths.ContactUs} className="text-purple-300">
              Contact Us
            </Link>{" "}
            and{" "}
            <Link href={RoutePaths.Calendly} className="text-purple-300">
  ...
  `}
      ...
      <DocumentSection
        ...
        description={
          <>
            Your use of our website is subject to our privacy policy, which outlines how we collect,
            use, and protect your personal information. By using our website, you consent to the
            terms of our privacy policy. For more information, please refer to our{" "}
            <Link href={RoutePaths.PrivacyPolicy} className="text-purple-300">
              Privacy Policy page
            </Link>
          </>
        }

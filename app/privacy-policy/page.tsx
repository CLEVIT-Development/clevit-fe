  ...
  return (
    <div className="w-full flex flex-col items-center space-y-[50px]">
      ...
      <DocumentSection
        ...
        listItems={[
          <>
            Personal Information: This includes information you provide voluntarily, such as your
            name, email address, phone number, and country when you make inquiries,{" "}
      ...
      <DocumentSection
        ...
        description2={
          <>
            If you have any questions or concerns about this Privacy Policy, our privacy practices,
            or the collection and use of your personal information, please contact us at{" "}
            <a className="text-purple-300" href="mailto:${appConfig.contactMail}">
              {appConfig.contactMail}.
            </a>
          </>

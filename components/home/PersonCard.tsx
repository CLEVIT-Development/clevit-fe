...
const PersonCard: React.FC<PersonCardProps> = ({
  ...
  <div className="flex flex-col desktop:items-start items-center min-w-[300px] text-center lg:border p-4 rounded-lg transform transition-transform duration-700 lg:hover:scale-105  ">
    {image ? (
      <img
        loading="lazy"
        src={image}

...
const TechnologySection = ({ title, subTitle, tabsConstant, technologiesConstant }: Props) => {
  ...
  return (
    <Section
      id="technologies"
      className="w-full bg-gray-300 px-5 md:px-20 lg:px-20 rounded-lg desktop:max-w-[1024px] lg:max-w-[1280px]"
    >
...
const getGridClass = (length: number) => {
  const gridClasses: { [key: number]: string } = {
    2: "desktop:flex desktop:gap-16",
    4: "desktop:grid desktop:grid-cols-4 desktop:justify-items-center",
    5: "desktop:justify-center md:grid md:grid-cols-5 md:justify-items-center",
    6: "desktop:justify-center md:grid md:grid-cols-3 md:justify-items-center lg:grid lg:grid-cols-6",
    7: "desktop:justify-center md:grid md:grid-cols-4 md:justify-items-center lg:grid lg:grid-cols-7",
    8: "desktop:justify-center md:grid md:grid-cols-4 md:justify-items-center lg:grid lg:grid-cols-8",
    10: "md:justify-items-center md:grid md:grid-cols-5 lg:grid lg:grid-cols-5",
    12: "md:justify-items-center lg:grid lg:grid-cols-6",
  };

  return gridClasses[length] || "";
};

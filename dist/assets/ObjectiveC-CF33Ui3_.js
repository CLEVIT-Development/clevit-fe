...
const a = (a) =>
  e.createElement(
    "svg",
    {
      ...
      viewBox: "0 0 119.99999 59.999994",
      id: "svg26",
    ...
    e.createElement(
      ...
      e.createElement(
        ...
        e.createElement(
          "cc:Work",
          { "rdf:about": "" },
          e.createElement("dc:format", null, "image/svg+xml"),
          e.createElement("dc:type", { "rdf:resource": "http://purl.org/dc/dcmitype/StillImage" }),
          e.createElement("dc:title", null, "Simpler &amp; easier ")
        )
      )
    ),
    e.createElement("sodipodi:namedview", {
      pagecolor: "#ffffff",
      bordercolor: "#666666",
      borderopacity: 1,
      objecttolerance: 10,
    ...
    e.createElement(
      "defs",
      { id: "defs4" },
      e.createElement("style", { id: "style2" }, ".cls-1{fill:#f1592a;}")
    ),
    e.createElement("title", { id: "title6" }, "Simpler &amp; easier "),
    e.createElement(
      "g",
      {
        id: "Layer_2",
        "data-name": "Layer 2",
        transform: "matrix(0.65762897,0,0,0.65762897,34.875476,4.8752901)",
      },
      e.createElement(
        "g",

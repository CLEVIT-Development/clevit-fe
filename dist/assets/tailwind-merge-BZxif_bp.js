const e = (e) => {
    const r = n(e),
      { conflictingClassGroups: l, conflictingClassGroupModifiers: s } = e;
    return {
      getClassGroupId: (e) => {
        const n = e.split("-");
        return "" === n[0] && 1 !== n.length && n.shift(), o(n, r) || t(e);
      },
      getConflictingClassGroupIds: (e, o) => {
        const r = l[e] || [];
        return o && s[e] ? [...r, ...s[e]] : r;
      },
    };
  },
  o = (e, r) => {
  ...
  n = (e) => {
    ...
    return (
      i(Object.entries(e.classGroups), r).forEach(([e, r]) => {
        l(r, t, e, o);
      }),
      t
    );
      ...
      ? e.map(([e, r]) => [
          ...
          r.map((e) =>
            "string" == typeof e
              ? o + e
              : "object" == typeof e
                ? Object.fromEntries(Object.entries(e).map(([e, r]) => [o + e, r]))
                : e
          ),
        ])
      : e,
  d = (e) => {
    ...
    return {
      get(e) {
        let o = r.get(e);
        return void 0 !== o ? o : void 0 !== (o = t.get(e)) ? (n(e, o), o) : void 0;
      },
      set(e, o) {
    ...
    const { separator: o, experimentalParseClassName: r } = e,
      ...
      s = (e) => {
        ...
        for (let p = 0; p < e.length; p++) {
          let d = e[p];
          if (0 === a) {
            if (d === n && (t || e.slice(p, p + l) === o)) {
              r.push(e.slice(i, p)), (i = p + l);
              continue;
            }
            if ("/" === d) {
              s = p;
        ...
        const d = 0 === r.length ? e : e.substring(i),
          c = d.startsWith("!");
        return {
          modifiers: r,
...
function b() {
  let e,
    ...
    r = 0,
    t = "";
  for (; r < arguments.length; ) (e = arguments[r++]) && (o = m(e)) && (t && (t += " "), (t += o));
  return t;
}
const m = (e) => {
  ...
  let o,
    r = "";
  for (let t = 0; t < e.length; t++) e[t] && (o = m(e[t])) && (r && (r += " "), (r += o));
  return r;
};
function g(o, ...r) {
  let t,
    ...
    l,
    s = function (i) {
      const p = r.reduce((e, o) => o(e), o());
      return (
        (t = ((o) => ({ cache: d(o.cacheSize), parseClassName: c(o), ...e(o) }))(p)),
        (n = t.cache.get),
        (l = t.cache.set),
        (s = a),
        a(i)
  ...
  function a(e) {
    ...
    if (o) return o;
    const r = ((e, o) => {
      const { parseClassName: r, getClassGroupId: t, getConflictingClassGroupIds: n } = o,
        l = [],
        s = e.trim().split(u);
      let a = "";
...
const f = (e) => {
  ...
  j = (e) => N(e) || y.has(e) || x.test(e),
  G = (e) => _(e, "length", A),
  N = (e) => Boolean(e) && !Number.isNaN(Number(e)),
  P = (e) => _(e, "number", N),
  I = (e) => Boolean(e) && Number.isInteger(Number(e)),
  ...
  _ = (e, o, r) => {
    const t = h.exec(e);
    return !!t && (t[1] ? ("string" == typeof o ? t[1] === o : o.has(t[1])) : r(t[2]));
  },
  A = (e) => w.test(e) && !k.test(e),
  D = () => !1,
  F = (e) => z.test(e),
  H = (e) => C.test(e),
  J = g(() => {
    ...
    return {
      ...
      theme: {
        ...
        gradientColorStopPositions: [M, G],
        inset: W(),
        margin: W(),
        opacity: H(),
        padding: _(),
      ...
      classGroups: {
        ...
        grow: [{ grow: F() }],
        shrink: [{ shrink: F() }],
        order: [{ order: ["first", "last", "none", I, S] }],
        "grid-cols": [{ "grid-cols": [T] }],
        "col-start-end": [{ col: ["auto", { span: ["full", I, S] }, S] }],
        "col-start": [{ "col-start": D() }],
        "col-end": [{ "col-end": D() }],
        "grid-rows": [{ "grid-rows": [T] }],
        "row-start-end": [{ row: ["auto", { span: [I, S] }, S] }],
        ...
        w: [{ w: ["auto", "min", "max", "fit", "svw", "lvw", "dvw", S, o] }],
        "min-w": [{ "min-w": [S, o, "min", "max", "fit"] }],
        "max-w": [
          { "max-w": [S, o, "none", "full", "min", "max", "fit", "prose", { screen: [$] }, $] },
        ],
        h: [{ h: [S, o, "auto", "min", "max", "fit", "svh", "lvh", "dvh"] }],
        "min-h": [{ "min-h": [S, o, "min", "max", "fit", "svh", "lvh", "dvh"] }],
        "max-h": [{ "max-h": [S, o, "min", "max", "fit", "svh", "lvh", "dvh"] }],
        size: [{ size: [S, o, "auto", "min", "max", "fit"] }],
        "font-size": [{ text: ["base", $, G] }],
        ...
        tracking: [{ tracking: ["tighter", "tight", "normal", "wide", "wider", "widest", S] }],
        "line-clamp": [{ "line-clamp": ["none", N, P] }],
        leading: [{ leading: ["none", "tight", "snug", "normal", "relaxed", "loose", j, S] }],
        ...
        "text-decoration-thickness": [{ decoration: ["auto", "from-font", j, G] }],
        "underline-offset": [{ "underline-offset": ["auto", j, S] }],
        ...
        "outline-offset": [{ "outline-offset": [j, S] }],
        "outline-w": [{ outline: [j, G] }],
        "outline-color": [{ outline: [e] }],
        "ring-w": [{ ring: A() }],
        "ring-w-inset": ["ring-inset"],
        "ring-color": [{ ring: [e] }],
        "ring-opacity": [{ "ring-opacity": [x] }],
        "ring-offset-w": [{ "ring-offset": [j, G] }],
        "ring-offset-color": [{ "ring-offset": [e] }],
        shadow: [{ shadow: ["", "inner", "none", $, q] }],
        ...
        "will-change": [{ "will-change": ["auto", "scroll", "contents", "transform", S] }],
        fill: [{ fill: [e, "none"] }],
        "stroke-w": [{ stroke: [j, G, P] }],

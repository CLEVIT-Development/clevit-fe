...
const u = s("string"),
  ...
  b = o("FileList"),
  g = o("URLSearchParams"),
  [w, E, O, R] = ["ReadableStream", "Request", "Response", "Headers"].map(o);
...
const x = (
  ...
  L = "0123456789",
  F = { DIGIT: L, ALPHA: _, ALPHA_DIGIT: _ + _.toUpperCase() + L };
const U = o("AsyncFunction"),
  B =
      ...
      : k
        ? ((q = `axios@${Math.random()}`),
          ...
          A.addEventListener(
            "message",
            ({ source: e, data: t }) => {
              e === A && t === q && I.length && I.shift()();
            },
            !1
          ),
          (e) => {
            I.push(e), A.postMessage(q, "*");
          })
        : (e) => setTimeout(e));
var D, k, q, I;
const M =
  ...
  z = {
    ...
    isFormData: (e) => {
      ...
      return (
        ...
        (("function" == typeof FormData && e instanceof FormData) ||
          (l(e.append) &&
            ("formdata" === (t = r(e)) ||
              ("object" === t && l(e.toString) && "[object FormData]" === e.toString()))))
      );
    },
    ...
    merge: function e() {
      ...
      for (let o = 0, s = arguments.length; o < s; o++) arguments[o] && S(arguments[o], r);
      return n;
    },
    ...
    isAsyncFn: U,
    isThenable: (e) => e && (d(e) || l(e)) && l(e.then) && l(e.catch),
    setImmediate: B,
    asap: M,
  };
...
const G = z.toFlatObject(z, {}, null, function (e) {
  return /^is[A-Z]/.test(e);
});
function X(e, t, n) {
  if (!z.isObject(e)) throw new TypeError("target must be an object");
  t = t || new FormData();
  const r = (n = z.toFlatObject(n, { metaTokens: !0, dots: !1, indexes: !1 }, !1, function (e, t) {
  ...
  function c(e) {
    ...
    if (!a && z.isBlob(e)) throw new H("Blob is not supported. Use a Buffer instead.");
      ...
      if (z.endsWith(n, "{}")) (n = r ? n : n.slice(0, -2)), (e = JSON.stringify(e));
        ...
        return (
          ...
          a.forEach(function (e, r) {
            !z.isUndefined(e) &&
              null !== e &&
              t.append(!0 === i ? $([n], r, s) : null === i ? n : n + "[]", c(e));
          }),
          !1
        );
    return !!K(e) || (t.append($(o, n, s), c(e)), !1);
  }
  const l = [],
    f = Object.assign(G, { defaultVisitor: u, convertValue: c, isVisitable: K });
  ...
  return (
    (function e(n, r) {
      if (!z.isUndefined(n)) {
        ...
        l.push(n),
          z.forEach(n, function (n, s) {
            !0 ===
              (!(z.isUndefined(n) || null === n) &&
                o.call(t, n, z.isString(s) ? s.trim() : s, r, f)) && e(n, r ? r.concat(s) : [s]);
          }),
          l.pop();
      }
    })(e),
...
function te(e, t, n) {
  ...
  const r = (n && n.encode) || ee,
    o = n && n.serialize;
  let s;
  if (((s = o ? o(t, n) : z.isURLSearchParams(t) ? t.toString() : new Z(t, n).toString(r)), s)) {
    const t = e.indexOf("#");
...
const re = { silentJSONParsing: !0, forcedJSONParsing: !0, clarifyTimeoutError: !1 },
  oe = {
    isBrowser: !0,
    classes: {
  ...
  ie = ("object" == typeof navigator && navigator) || void 0,
  ae = se && (!ie || ["ReactNative", "NativeScript", "NS"].indexOf(ie.product) < 0),
  ce =
    "undefined" != typeof WorkerGlobalScope &&
    self instanceof WorkerGlobalScope &&
    "function" == typeof self.importScripts,
  ue = (se && window.location.href) || "http://localhost",
  le = {
    ...Object.freeze(
...
const de = {
  ...
  transformRequest: [
    function (e, t) {
      ...
      if (z.isFormData(e)) return r ? JSON.stringify(fe(e)) : e;
      if (
        z.isArrayBuffer(e) ||
        z.isBuffer(e) ||
        z.isStream(e) ||
  ...
  transformResponse: [
    function (e) {
      const t = this.transitional || de.transitional,
        ...
        try {
          ...
          if (n) {
            if ("SyntaxError" === o.name)
              throw H.from(o, H.ERR_BAD_RESPONSE, this, null, this.response);
            throw o;
          }
        }
      }
...
function ye(e) {
  return !1 === e || null == e ? e : z.isArray(e) ? e.map(ye) : String(e);
}
...
class ge {
  ...
  set(e, t, n) {
    ...
    function o(e, t, n) {
      ...
      (!s || void 0 === r[s] || !0 === n || (void 0 === n && !1 !== r[s])) && (r[s || t] = ye(e));
    }
    ...
    else if (z.isHeaders(e)) for (const [i, a] of e.entries()) o(a, i, n);
    else null != e && o(t, e, n);
    return this;
  }
  get(e, t) {
  ...
  delete(e, t) {
    ...
    function o(e) {
      if ((e = me(e))) {
        ...
        !o || (t && !be(0, n[o], o, t)) || (delete n[o], (r = !0));
      }
    }
  ...
  clear(e) {
    ...
    for (; n--; ) {
      const o = t[n];
      (e && !be(0, this[o], o, e, !0)) || (delete this[o], (r = !0));
    }
    return r;
  }
  normalize(e) {
    ...
    return (
      z.forEach(this, (r, o) => {
        ...
        if (s) return (t[s] = ye(r)), void delete t[o];
        const i = e
          ? (function (e) {
              return e
                .trim()
...
ge.accessor([
  ...
  z.reduceDescriptors(ge.prototype, ({ value: e }, t) => {
...
const Se = (e, t, n = 3) => {
  ...
  ve = le.hasStandardBrowserEnv
    ? (function () {
        const e = le.navigator && /(msie|trident)/i.test(le.navigator.userAgent),
...
const je = (e) => (e instanceof ge ? { ...e } : e);
function Ne(e, t) {
  t = t || {};
  const n = {};
  function r(e, t, n) {
...
const Pe = (e) => {
    ...
    if (
      ((t.headers = a = ge.from(a)),
      (t.url = te(Ce(t.baseURL, t.url), e.params, e.paramsSerializer)),
      c &&
        a.set(
          "Authorization",
          "Basic " +
      ...
      if (le.hasStandardBrowserEnv || le.hasStandardBrowserWebWorkerEnv) a.setContentType(void 0);
    ...
    if (
      ...
      (o && z.isFunction(o) && (o = o(t)), o || (!1 !== o && ve(t.url)))
    ) {
      const e = s && i && xe.read(i);
      e && a.set(s, e);
    }
    return t;
  },
  _e =
    ...
    function (e) {
      return new Promise(function (t, n) {
        const r = Pe(e);
        let o = r.data;
        const s = ge.from(r.headers).normalize();
        let i,
          a,
          c,
          u,
        ...
        function y() {
          if (!m) return;
          const r = ge.from("getAllResponseHeaders" in m && m.getAllResponseHeaders());
          Re(
            function (e) {
              t(e), p();
            },
        ...
        m.open(r.method.toUpperCase(), r.url, !0),
          ...
          (m.ontimeout = function () {
            ...
            const o = r.transitional || re;
            r.timeoutErrorMessage && (t = r.timeoutErrorMessage),
              n(new H(t, o.clarifyTimeoutError ? H.ETIMEDOUT : H.ECONNABORTED, e, m)),
              (m = null);
          }),
          void 0 === o && s.setContentType(null),
          "setRequestHeader" in m &&
            z.forEach(s.toJSON(), function (e, t) {
              m.setRequestHeader(t, e);
            }),
          z.isUndefined(r.withCredentials) || (m.withCredentials = !!r.withCredentials),
          f && "json" !== f && (m.responseType = r.responseType),
          h && (([c, l] = Se(h, !0)), m.addEventListener("progress", c)),
          d &&
            m.upload &&
            (([a, u] = Se(d)),
          ...
          (r.cancelToken || r.signal) &&
            ((i = (t) => {
              m && (n(!t || t.type ? new Oe(null, e, m) : t), m.abort(), (m = null));
            }),
    ...
    if (t || n) {
      ...
      const o = function (e) {
        if (!n) {
          ...
          r.abort(t instanceof H ? t : new Oe(t instanceof Error ? t.message : t));
        }
      };
      let s =
        t &&
  ...
  Be = (e, t, n, r) => {
    const o = (async function* (e, t) {
      for await (const n of Ue(e)) yield* Fe(n, t);
    })(e, t);
    let s,
      i = 0,
      a = (e) => {
  ...
  De = "function" == typeof fetch && "function" == typeof Request && "function" == typeof Response,
  ke = De && "function" == typeof ReadableStream,
  qe =
    De &&
    ("function" == typeof TextEncoder
      ? ((Ie = new TextEncoder()), (e) => Ie.encode(e))
...
const Me = (e, ...t) => {
  ...
  He = ke && Me(() => z.isReadableStream(new Response("").body)),
  Je = { stream: He && ((e) => e.body) };
var We;
De &&
  ((We = new Response()),
  ["text", "arrayBuffer", "blob", "formData", "stream"].forEach((e) => {
    !Je[e] &&
      (Je[e] = z.isFunction(We[e])
        ? (t) => t[e]()
        : (t, n) => {
    ...
    return null == n
      ? (async (e) => {
          ...
          if (z.isSpecCompliantForm(e)) {
            const t = new Request(le.origin, { method: "POST", body: e });
            return (await t.arrayBuffer()).byteLength;
          }
          return z.isArrayBufferView(e) || z.isArrayBuffer(e)
            ? e.byteLength
            : (z.isURLSearchParams(e) && (e += ""),
              z.isString(e) ? (await qe(e)).byteLength : void 0);
        })(t)
      : n;
  },
  Ve = {
    ...
    fetch:
      ...
      (async (e) => {
        ...
        let y;
        try {
          if (c && ze && "get" !== n && "head" !== n && 0 !== (y = await Ke(l, r))) {
            let e,
              n = new Request(t, { method: "POST", body: r, duplex: "half" });
            if (
              (z.isFormData(r) && (e = n.headers.get("content-type")) && l.setContentType(e),
              n.body)
            ) {
              const [e, t] = Te(y, Se(Ae(c)));
          ...
          let s = await fetch(h);
          const i = He && ("stream" === u || "response" === u);
          if (He && (a || (i && m))) {
            const e = {};
            ["status", "statusText", "headers"].forEach((t) => {
              e[t] = s[t];
            });
            const t = z.toFiniteNumber(s.headers.get("content-length")),
              [n, r] = (a && Te(t, Se(Ae(a), !0))) || [];
            s = new Response(
              Be(s.body, 65536, n, () => {
                r && r(), m && m();
              }),
          ...
          u = u || "text";
          let b = await Je[z.findKey(Je, u) || "text"](s, e);
          return (
            !i && m && m(),
            await new Promise((t, n) => {
              Re(t, n, {
                data: b,
                headers: ge.from(s.headers),
                status: s.status,
          ...
          if ((m && m(), b && "TypeError" === b.name && /fetch/i.test(b.message)))
            throw Object.assign(new H("Network Error", H.ERR_NETWORK, e, h), {
              cause: b.cause || b,
            });
          throw H.from(b, b && b.code, e, h);
        }
      }),
  };
z.forEach(Ve, (e, t) => {
...
const $e = (e) => `- ${e}`,
  Ge = (e) => z.isFunction(e) || null === e || !1 === e,
  Xe = (e) => {
    e = z.isArray(e) ? e : [e];
    const { length: t } = e;
    let n, r;
    ...
    for (let s = 0; s < t; s++) {
      let t;
      if (((n = e[s]), (r = n), !Ge(n) && ((r = Ve[(t = String(n)).toLowerCase()]), void 0 === r)))
...
function Ze(e) {
  ...
  return Xe(e.adapter || de.adapter)(e).then(
    function (t) {
      return (
        Qe(e), (t.data = we.call(e, e.transformResponse, t)), (t.headers = ge.from(t.headers)), t
      );
    },
    function (t) {
      return (
        Ee(t) ||
          ...
          t &&
            t.response &&
            ((t.response.data = we.call(e, e.transformResponse, t.response)),
...
et.transitional = function (e, t, n) {
  return (r, o, s) => {
    ...
    return t && !tt[o] && (tt[o] = !0), !e || e(r, o, s);
  };
};
const nt = {
    assertOptions: function (e, t, n) {
      ...
      for (; o-- > 0; ) {
        ...
        if (i) {
          const t = e[s],
            n = void 0 === t || i(t, s, e);
          if (!0 !== n) throw new H("option " + s + " must be " + n, H.ERR_BAD_OPTION_VALUE);
        } else if (!0 !== n) throw new H("Unknown option " + s, H.ERR_BAD_OPTION);
      }
    },
    validators: et,
  },
...
class ot {
  ...
  _request(e, t) {
    ...
    void 0 !== n &&
      ...
      null != r &&
        (z.isFunction(r)
          ...
          : nt.assertOptions(r, { encode: rt.function, serialize: rt.function }, !0)),
      (t.method = (t.method || this.defaults.method || "get").toLowerCase());
    let s = o && z.merge(o.common, o[t.method]);
    o &&
      z.forEach(["delete", "get", "head", "post", "put", "patch", "common"], (e) => {
        delete o[e];
      }),
      (t.headers = ge.concat(s, o));
    const i = [];
    let a = !0;
    ...
    if (!a) {
      ...
      for (e.unshift.apply(e, i), e.push.apply(e, c), l = e.length, u = Promise.resolve(t); f < l; )
        u = u.then(e[f++], e[f++]);
      return u;
    }
    l = i.length;
  ...
  getUri(e) {
    return te(Ce((e = Ne(this.defaults, e)).baseURL, e.url), e.params, e.paramsSerializer);
  }
}
...
const at = (function t(n) {
  const r = new ot(n),
    o = e(ot.prototype.request, r);
  return (
    z.extend(o, ot.prototype, r, { allOwnKeys: !0 }),
...
(at.Axios = ot),
  ...
  (at.mergeConfig = Ne),
  (at.AxiosHeaders = ge),
  (at.formToJSON = (e) => fe(z.isHTMLForm(e) ? new FormData(e) : e)),
  (at.getAdapter = Xe),

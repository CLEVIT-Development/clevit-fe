...
const ServiceCard = ({ id, icon, title, route, className }: Props) => {
  ...
  return (
    <div
      ...
      ref={sectionCardRef}
      className={twMerge(
        "desktop:py-16 py-8 rounded-2xl  transition-all duration-500 hover:shadow-[0px_35.63px_95.02px_0px_rgba(44,22,84,0.07)] hover:scale-110  desktop:w-[314px] w-[235px] text-center space-y-4 flex flex-col justify-center items-center",
        className
      )}
    >

...
const ProcessCard = ({ order, title, icon, className, description }: Props) => (
  <div
    className={twMerge(
      "transition-all duration-500 group hover:scale-105 relative bg-white z-[1] shadow-base-200 border-[1px] border-purple-100 rounded-lg-l w-[200px] min-h-[270px] flex flex-col items-center justify-center gap-2",
      className
    )}
  >
    <div className="px-4 flex flex-col mt-9 items-center space-y-2.5">
      {icon}

...
const InfrastructureCodeIcon = lazy(
  () => import("@/assets/vectors/processes/InfrastructureCode.svg?react")
);
const ReportingRecommendationsIcon = lazy(
  () => import("@/assets/vectors/processes/ReportingRecommendations.svg?react")
);
const PerformanceTestingIcon = lazy(
  () => import("@/assets/vectors/processes/PerformanceTesting.svg?react")
);
const SecurityCompilanceAuditIcon = lazy(
  () => import("@/assets/vectors/processes/SecurityCompilanceAudit.svg?react")
);

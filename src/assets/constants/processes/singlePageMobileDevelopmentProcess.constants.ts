...
const SupportPerformanceIcon = lazy(
  () => import("@/assets/vectors/processes/SupportPerformance.svg?react")
);

const TestingAndQAIcon = lazy(() => import("@/assets/vectors/processes/TestingAndQA.svg?react"));
const ConsultationIcon = lazy(() => import("@/assets/vectors/processes/Consultation.svg?react"));

const RocketIcon = lazy(() => import("@/assets/vectors/processes/Rocket.svg?react"));
const PreparatinIcon = lazy(() => import("@/assets/vectors/processes/Preparation.svg?react"));
const UIUXIcon = lazy(() => import("@/assets/vectors/processes/UIUX.svg?react"));
const ApplicationDevelopmentIcon = lazy(
  () => import("@/assets/vectors/processes/ApplicationDevelopment.svg?react")
);

...
const Figma = lazy(() => import("@/assets/vectors/technology/Figma.svg?react"));
const AdobeXD = lazy(() => import("@/assets/vectors/technology/AdobeXD.svg?react"));
const AdobeIllustrator = lazy(
  () => import("@/assets/vectors/technology/AdobeIllustrator.svg?react")
);
const AdobePhotoshop = lazy(() => import("@/assets/vectors/technology/AdobePhotoshop.svg?react"));

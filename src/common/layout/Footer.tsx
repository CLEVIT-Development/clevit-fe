    ...
    <footer className="flex flex-col space-y-6 w-full bg-black px-20 pt-12 pb-6">
      <div className="flex space-x-[150px] justify-between">
        <div className="flex flex-col space-y-4">
          ...
          <p className="text-gray100 max-w-[340px]">
      ...
      <div className="h-[1px] -mx-20 bg-gray100" />
      <div className="flex justify-between">
        <div className="flex items-center space-x-2">
          <Link to={"link1"} className="font-medium text-[12px] text-gray100">
            Privacy Policy
          </Link>
          <div className="w-[1px] h-full bg-gray100" />
          <Link to={"link2"} className="font-medium text-[12px] text-gray100">
            Terms of Conditions
          </Link>
        </div>
        <p className="font-medium text-gray100">
          <span className="text-gray100 font-semibold">&copy; </span>
          {getFullYear()} Clevit
        </p>
      </div>
    </footer>

...
const Heading = forwardRef((_, ref: LegacyRef<HTMLDivElement>) => {
  return (
    <Gradient ref={ref}>
      <div className="flex flex-col items-center text-center desktop:pb-20 desktop:pt-[240px] xs:pb-6 xs:pt-[125px] xs:px-[30px]">
        ...
        <p className="text-white text-center desktop:max-w-[80%] md:text-lg xs:text-base desktop:mt-4 desktop:mb-9 xs:mt-6">

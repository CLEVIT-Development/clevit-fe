  ...
  return (
    <footer className="flex gap-44 bg-black pl-20 pt-12 pb-80">
      <div>
        ...
        <p className="text-gray100 mt-4 max-w-[340px]">As a leading web and mobile app development company, Clevit
          empowers businesses across all sectors to unlock their full digital potential.</p>

...
const ContactUsTopBanner = ({ image, title, description, imageAlt }: IBookConsultationProps) => {
  ...
  return (
    <div className="w-full desktop:h-[450px] rounded-xl bg-violet-500 bg-gradient-to-br from-[#0A0240] to-[rgba(10,2,64,0.8)] flex desktop:justify-between px-5 py-5 desktop:pr-[164px] md:pr-0 desktop:pl-12 md:justify-center md:py-10">

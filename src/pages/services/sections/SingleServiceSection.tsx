      ...
      <Section>
        ...
        <div>
          <div className="w-full flex justyfy-center">
            <div className="max-w-[1230px] flex flex-wrap justify-start items-start desktop:items-center desktop:gap-20 gap-6 px-5 desktop:px-0 ">
              {service?.offers?.map(({ Icon, description, title }) => {
                return (
                  <div className="desktop:w-[350px] w-[90%] flex flex-col mt-5 gap-4">
                    <Icon />

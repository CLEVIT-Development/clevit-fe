...
const SingleServiceSection = ({ serviceId, setHeaderItems }: SingleServiceSectionProps) => {
  ...
  return (
    <div className="flex flex-col items-center w-full desktop:p-0 px-5">
      <Section className="p-0 px-0">
        ...
        <div className="flex flex-col justify-center gap-6 text-center !mt-0">
          <div className="flex flex-col items-center gap-6 px-5 pt-24">
          ...
          <div className="flex w-screen pl-5 desktop:pl-0 desktop:w-full overflow-x-auto flex-nowrap justify-around desktop:py-5 gap-2 ">
      ...
      <div className="flex flex-col gap-12 items-center mt-5">
        <h3 className="desktop:text-2xl text-lg text-center text-[#314252]">
          {service.ChooseClevitTitle}
        </h3>
        <div
          className={`grid desktop:gap-20 gap-6 justify-center ${

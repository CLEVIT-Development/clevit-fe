...
const TotalItem = ({ value, title }: TotalItemProps) => (
  <div className="flex flex-col md:items-start items-center">
    <p className="md:text-4xl text-2xl-3xl text-white">{value}</p>
    <p className="md:text-md-l text-md text-white">{title}</p>
  </div>
);
  ...
  return (
    <Section>
      <div
        ...
        className="w-full flex md:justify-evenly md:space-y-0 space-y-8 md:flex-row flex-col items-center bg-purple-600 md:py-[60px] py-5 rounded-lg-l bg-no-repeat md:bg-totalDesktopPosition bg-totalMobilePosition"
      >

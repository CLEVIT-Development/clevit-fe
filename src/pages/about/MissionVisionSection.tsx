...
const MissionVisionSection = () => {
  ...
  return (
    <section
      ...
      className="bg-gray-500 -z-[40] rounded-lg-l md:space-y-12 space-y-6 py-12 md:pl-[100px] md:pr-[53px] pl-[20px] pr-[20px] bg-no-repeat md:bg-missionDesktopPosition bg-missionMobilePosition"
    >
      <MissionSingleItem
        title="Mission"

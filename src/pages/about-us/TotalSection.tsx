...
const TotalItem = ({ value, title }: TotalItemProps) => (
  <div className="desktop:max-w-auto desktop:w-[323px] flex flex-col md:items-center rounded-[28px] bg-white	 items-center  py-6 shadow-[0px_35.63px_95.02px_0px_rgba(44,22,84,0.07)]">
    <span className="md:text-4xl text-2xl text-purple-300">{value}</span>
  ...
  return (
    <Section className="self-center desktop:max-w-[80%]">
      <div
        ...
        className="w-full flex-1 flex md:justify-evenly md:space-y-0 space-y-1 md:flex-row flex-col items-center md:py-[60px] md:px-[30px] py-5 rounded-lg-l bg-no-repeat md:bg-totalDesktopPosition bg-totalMobilePosition"
      >

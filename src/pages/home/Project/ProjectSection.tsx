...
const ProjectSection = () => {
  ...
  return (
    <Section title="Web Apps We Developed" className="md:py-12 xs:py-5">
      <div className="w-full desktop:-mx-20 xs:-mx-5 max-w-[100vw]">
        <AliceCarousel
          autoPlay
                ...
                <div className="flex flex-col justify-start md:space-y-[65px] xs:space-y-[30px]">
                  ...
                  <div className="flex flex-col space-y-2 items-start w-fit">
                    <p className="text-white desktop:text-md xs:text-sm !font-semibold">
                      Type:
                      <span className="font-normal desktop:text-md xs:text-base ml-2">{type}</span>
                    </p>
                    <p className="text-white desktop:text-md xs:text-sm !font-semibold">
                      Duration:

      ...
      feedbacksConstants.map(({ id, companyLogo, description, author, position }) => {
        return (
          <div
            ...
            className={twMerge(
              classNames(
                "transition-all duration-500 bg-white rounded-lg-l shadow-lg md:min-h-[600px] min-h-[550px] hover:scale-105 flex flex-col justify-between items-start px-4 desktop:pt-8 xs:pt-5 pb-6",

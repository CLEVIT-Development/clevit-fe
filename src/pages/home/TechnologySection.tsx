...
const TechnologySection = () => {
  ...
  return (
    <Section
      ...
      className="bg-gray-300 desktop:py-12 desktop:px-[46px] md:mx-0 xs:-mx-5 xs:py-5 xs:px-[24px] rounded-[10px] space-y-9"
    >
      <div className="flex flex-col items-center space-y-[58px] w-full">
        ...
        <div
          key={currTabId}
          className={`w-full relative desktop:flex desktop:flex-wrap justify-around desktop:items-stretch xs:grid md:grid-cols-4 sm:grid-cols-3 xs:grid-cols-2 ${swipeAnimationConstants[direction as keyof typeof swipeAnimationConstants]}`}
        >
